...
func (r *RedisCache) Set(ctx context.Context, key string, val interface{}, timeout time.Duration) error {
...
func NewRedisCache(params ...interface{}) (interface{}, error) {
	...
	client, err := redisService.GetClient(redis.WithConfigPath("cache.redis"))
	if err != nil {
		return nil, err
	}
